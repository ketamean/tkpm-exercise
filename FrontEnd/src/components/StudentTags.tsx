        ...
        >
            ...
            <form
                onSubmit={(e) => {
                    ...
                    console.log(data)
                    axios
                        .put(`http://localhost:3000/?id=${props.student.id}`, data, {
                            headers: {
        ...
        >
            ...
            <form className='flex flex-row justify-center gap-12 items-center pt-8'
                onSubmit={(e) => {
                    ...
                    axios
                        .delete(`http://localhost:3000/?id=${props.student.id}`)
                        .then(() => window.location.reload())
                }}
            >
...
export default function StudentTags(props: StudentTagsProps): any {
    ...
    return (
        <>
            ...
            <UpdateModal student={props.student} updateModalState={updateModalState} setUpdateModalState={setUpdateModalState} />
